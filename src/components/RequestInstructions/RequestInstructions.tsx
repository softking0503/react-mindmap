...
export default function RequestInstructions() {
    ...
    return (
        <div className="w-full flex flex-col gap-[20px]">
            <h1 className="text-[24px]">Request Instructions</h1>
            <TextArea autoSize={{ minRows: 6, maxRows: 10 }} className="text-[18px]" value={requestInstruction} onChange={(e) => { setRequestInstructions(e.target.value) }} />
        </div>
    )
}
