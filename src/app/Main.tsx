...
const DynamicMindMap = dynamic(() => import('@/components/Map/MindMap'), { ssr: false });
...
export default function Main() {
    return (
        <div className="px-[50px] py-[30px] w-full h-auto flex flex-col">
            <div className='border-[1px] border-black border-solid'>
                <Header />
                <div className='w-full h-auto p-[30px] flex flex-col gap-[30px]'>
                    <OptionGroup />
                    <DynamicMindMap />
                    <RequestInstructions />
                    <Configuration />
